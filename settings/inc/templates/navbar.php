...
<nav class="navbar navbar-inverse" >
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="../"><div class="row"><img  src="../<?php echo getUserInfo('user_img',$userid); ?>"/><?php echo $row['first_name']?></div></a>
    </div>


    <div class="collapse navbar-collapse" id="app_nav" >
      <ul class="nav navbar-nav">
        <li><a href="../index.php"><i class="fa fa-home"></i><span></span></a></li>
     ...
     <!-- <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          ...
          <ul class="nav navbar-nav right">
            ...
            <li><a href="index.php"><i class="fa fa-cog"> </i> </a></li>
